              ...
              <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <!--Visual Only: Like and Comment features are not yet functional -->
                            <div class="container-fluid d-flex justify-content-between align-items-center mb-2 interaction-container">
                                <button class="btn btn-sm btn-outline-primary like-button">
                                    👍 Like
                                </button>
                                <div class="mb-2 d-flex">
                                    <input type="text" class="form-control p-3 comment-section" style="border-radius: 100px 0 0 100px;" placeholder="Add a comment...">
                                    <button class="btn btn-primary" style="border-radius: 0 100px 100px 0;">Post</button>
                                </div>
                            </div>
                        </div>
                    </div>            
